...
HD_PWD='C:/hdl_projects/nexys_video/project_1/project_1.runs/design_1_dvi2rgb_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_dvi2rgb_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_dvi2rgb_0_0.tcl
